...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Latest blog posts covering various categories including " +
      (uniqueCategories.join(", ") || "no categories"),
    openGraph: {
      title: "The Editing Blog - Latest Posts",
      description:
        "Read the latest blog posts across categories: " +
        (uniqueCategories.join(", ") || "no categories"),
      url: "https://editingthing.com/blog",
      type: "website",
      images: posts[0]?.author.image
        ? [{ url: posts[0].author.image, alt: posts[0].author.name }]
        : [],
    },
